...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-10-2024 a las 09:28:24
...
(7, 'admin', 'admin', 'admin@example.com', 'admin', '2024-10-14 10:53:37');
...
--
ALTER TABLE `archivos`
  ADD CONSTRAINT `archivos_ibfk_1` FOREIGN KEY (`carpeta_id`) REFERENCES `carpetas` (`id`) ON DELETE SET NULL,
...
--
ALTER TABLE `carpetas`
  ADD CONSTRAINT `carpetas_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;
